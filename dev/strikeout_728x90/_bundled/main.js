...
function standard() {
	...
	tl.to(".t2", { duration: .2, opacity: 0 }, "+=" + read.njasb);
...
},{"./helpers/helpers.js":1,"./proline":2}],4:[function(require,module,exports){
"use strict";

var _commonJsStrikeoutJs = require('../../_common/js/strikeout.js');
...
(0, _commonJsStrikeoutJs.b_728x90)(tl);

},{"../../_common/js/strikeout.js":3}]},{},[4])
